...
#let show_information(textfill, personal_info, contact_info) = {
  ...
  grid(
    ...
    align(right)[
      == Contact Information
      #box(image("figs/github-mark.svg", height: 0.6em)) #link(contact_info.github_link)[#contact_info.github_name] \
      #box(image("figs/Telegram_logo.svg", height: 0.6em)) #link(contact_info.telegram_link)[#contact_info.telegram_name] \
      #box(image("figs/LinkedIn_Logo.svg", height: 0.6em)) #link(contact_info.linkedin_link)[#contact_info.linkedin_name] \
      // #box(image("figs/Twitter_logo.svg", height: 0.6em)) Twitter: #link(contact_info.twitter_link)[#contact_info.twitter_name] \
      $𝕏$ #link(contact_info.twitter_link)[#contact_info.twitter_name] \
      #box(image("figs/reddit-logo.svg", height: 0.6em)) #link(contact_info.reddit_link)[#contact_info.reddit_name] \
    ]
  )
  v(20pt, weak: true)
}
